...
public class PlotSettings {
    ...
    public PlotSettings(String plot_name)
    {
        ...
        this.plugin = SPlots.getInstance();
    ...
    public void save()
    {
        this.plugin.getDatabase().update("UPDATE `" + plugin.getDatabase().getTable_plots_settings() + "` SET `plot-settings`='" + this.convertToString() + "' WHERE `plot-name`='" + this.plot_name + "';");
    }
