...
public class PlotGUI {
    ...
    public static Inventory getRankingInventory(Player player)
    {
        ...
        ArrayList topPlots = SPlots.getInstance().getPlotManager().getTopPlots();
    ...
    public static Inventory getPlotUpgradeInventory(Player player, Plot plot)
    {
        ...
        if(plot.isMob_exp_upgrade()) {
            mob_exp_meta.setLore(ChatUtil.fixColors(Arrays.asList(
                    ...
                    "",
                    "&7Drop&8: &f2x",
                    "&7Koszt&8: &f$" + SPlots.getInstance().getConfig_manager().getMob_exp_upgrade_cost(),
                    "",
        ...
        if(plot.isMob_drop_upgrade()) {
            mob_drop_meta.setLore(ChatUtil.fixColors(Arrays.asList(
                    ...
                    "",
                    "&7Drop&8: &f2x",
                    "&7Koszt&8: &f$" + SPlots.getInstance().getConfig_manager().getMob_drop_upgrade_cost(),
                    "",
                    "&aMasz juz to ODBLOKOWANE!"
            )));
        }
        ...
        if(plot.isSpeed_upgrade()) {
            speed_meta.setLore(ChatUtil.fixColors(Arrays.asList(
                    ...
                    "",
                    "&7Speed&8: &fII",
                    "&7Koszt&8: &f$" + SPlots.getInstance().getConfig_manager().getSpeed_upgrade_cost(),
                    "",
                    "&aMasz juz to ODBLOKOWANE!"
            )));
        }
        ...
        if(plot.isJump_upgrade()) {
            jump_boost_meta.setLore(ChatUtil.fixColors(Arrays.asList(
                    ...
                    "",
                    "&7Jump Boost&8: &fII",
                    "&7Koszt&8: &f$" + SPlots.getInstance().getConfig_manager().getJump_boost_upgrade_cost(),
                    "",
                    "&aMasz juz to ODBLOKOWANE!"
            )));
        }
        ...
        int increase_cost = SPlots.getInstance().getConfig_manager().getPlot_increase_field_cost();
        switch(plot.getSize())
        {
            case 16:
                break;
    ...
    public static Inventory getPlotCreateInventory(Player player)
    {
        ...
        ItemMeta itemMeta = item.getItemMeta();
        itemMeta.setDisplayName(ChatUtil.fixColorsWithPrefix("&e&lStworz dzialke"));
        itemMeta.setLore(ChatUtil.fixColors(Arrays.asList(
                ...
                "",
                "&7Cena: &a$" + SPlots.getInstance().getConfig_manager().getPlot_create_cost(),
                "",
                "&e&oINFO:",
